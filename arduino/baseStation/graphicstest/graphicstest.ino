...
void setup(void) {
 ...
 /// testlines(tft.Color565(255, 0, 255));
  ...
  delay(2000);
   tft.fillScreen(ST7735_WHITE);
//ldrawArrows(true,true,true,true,ST7735_RED);
...
void loop() {
     tft.fillScreen(ST7735_WHITE);
/*
    drawArrows(true,false,false,false,ST7735_RED);
  delay(500);
     tft.fillScreen(ST7735_WHITE);

    drawArrows(false,true,false,false,ST7735_RED);
  delay(500);
     tft.fillScreen(ST7735_WHITE);

    drawArrows(false,false,true,false,ST7735_RED);
  delay(500);
     tft.fillScreen(ST7735_WHITE);

    drawArrows(false,false,false,true,ST7735_RED);
  delay(500);
     tft.fillScreen(ST7735_WHITE);

  drawArrows(true,true,true,true,ST7735_RED);
  
  */
  float osH = overSampleHeading();
